...
\label{sec:org1988e11}
\section{Portrait page}
\label{sec:orgaf15c0b}

\texttt{doc/examples/cal-plain.tex}

\subsection{Full page photo, calendar days overlaid with opacity}
\label{sec:org7b7e9ca}
...
\label{sec:org3c8f201}

\subsection{Portrait year planner}
\label{sec:org061de3f}
...
\label{sec:org4aa9d39}

\subsection{Showtrims}
\label{sec:org98fdab4}
